...
class MailSender {
  ...
  getTransporter() {
    ...
    const transporter = nodemailer.createTransport({
      host: this.data.mail.security.host,
      port: this.data.mail.security.port,
      secure: this.data.mail.security.ssl,
      auth: {
        user: this.data.mail.auth.user,
        pass: this.data.mail.auth.pass
      },
    });
